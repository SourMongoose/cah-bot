...
def temp():
    ...
    global black_fr, white_fr
    black_fr = [
        "_, ca m'empêche souvent de dormir.",
        "j'ai une tonne de problèmes, mais _ n'en est pas un.",
        "Le meilleur ami de la femme ? C'est certainement _ et de loin.",
        "Cette odeur me rapelle _",
        "C'est de cette facon que le monde se termine. Pas avec un pétard mais avec _.",
        "Quel est le point faible de Batman ?",
        "AirFrance interdit maintenant _ dans les avions.",
        "Ce qui à mis fin à mon couple?",
        "Je bois pour oublier _.",
        "Je suis désolé monsieur, mais je n'ai pas pu terminer mes devoirs à cause de _.",
        "C'est quoi ce bruit ?",
        "Je me demandes quel sera le prochain jouet dans les Happy Meal?",
        "C'est vraiment dommage que de nos jours, la gamins aient des problèmes avec _.",
        "_. C'est de cette facon que je veux mourir",
        "Le truc preferé de Hanouna?",
        "Qu'est-ce qui est le plus emo?",
        "Au lieu d'un coup de fouet, le père noel donne maintenant _ aux enfants sur la mauvaise liste.",
        "Le prochain block buster de J.K. Rowling: Harry Potter et la chambre des _.",
        "Un dîner romantique à la chandelle serait incomplet sans _.",
        "Les blancs aiment _.",
        "_ je paries que tu en as plein!",
        "La guerre !\n\nEn quoi c'est bon ?",
        "Laurent Ruquier est juste là pour _.",
        "_.Topes-la.",
        "Quand je baise, j'aime penser à _.",
        "Devinez ce que j'ai ramené de Mexico ?",
        "Qu'est-ce que me cachent mes parents ?",
        "J'ai perdu mon job à cause de _.",
        "Qu'est-ce que mamie trouverait perturbant et en même temps très attractif ?",
        "Les U.S. ont osé balancer _ sur les Afghans.",
        "Qu'est-ce qui aide Francois Hollande à se détendre en fin de journée ?",
        "Qu'est-ce qu'on trouve par millions au paradis ?",
        "La ligue 1 a banni _ car il donnait aux équipes un avantage trop grand.",
        "Si j'etais millionnaire, j'erigerais une statue de 20 mètres à l'effigie de _.",
        "La nouvelle recette minceur ?",
        "Si j'etais président de la France, je créerait le ministère de _.",
        "_. C'est un piège!",
        "Comment je maintiens mes relations sociales ?",
        "Qu'est ce que je pourrais ramener dans le passé si je devais faire croire aux gens que je suis un puissant sorcier ?",
        "Pendant que les U.S. ont fait la course pour la lune avec l'URSS, le gouvernement Mexicain à investi des millions de pesos dans la recherhe sur _.",
        "Bientôt en concert, _: Le show.",
        "Mon pouvoir secret ?",
        "Ce qui me donne envie de péter ?",
        "Mais avant de vous tuer, Mr. Bond, je dois vous montrer _.",
        "Qu'est-ce qui marche toujours pour ambiancer une soirée ?",
        "Ce que j'abandonne apres mon mariage ?",
        "L'odeur des vieux me fait penser à _. ",
        "La sortie scolaire a été gachée par _.",
        "Quand le pharaon resta impassible, Moïse appela _.",
        "Je sais pas quelles armes on utilisera pour la 3e guerre mondiale mais ce qui est sûr, c'est que pour la 4e on utilisera _.",
        "Des etudent montrent que les rats soumis à _ ont de meilleurs reflexes.",
        "Mon remède à l'addiction ?",
        "Et le diplôme académique pour _ revient à _.",
        "Pour mon prochain tour, je vais sortir _ de _.",
        "_: c'est bon jusqu'à la fin.",
        "_: testé par des enfants.",
        "ce qu'il y a de mieux avec l'âge  ?",
        "Je n'ai jamais vraiment compris _ jusqu'à ce que je voies _.",
        "La rumeur dit que le plat préfére de Poutine est le _ fourré au _.",
        "_. Faites-en un poême",
        "_ est une pente glissante qui mène à _.",
        "Dans un monde ravagé par _ notre seul espoir est _.",
        "Quand j'etais defoncé, j'ai vu _ se transformer en _.",
        "_ + _ = _.",
        "Apres le séisme d'Haiti, Nicolas Hulot à amené _ aux habitants.",
        "A Abidjan, tu peux avoir _ pour 1 euro.",
        "Peut-etre qu'elle est née comme ca, ou alors peut être que c'est à cause de _.",
        "La vie des natifs a brutalement changé quand les blancs ont apporté _.",
        "1: _. 2: _. 3: Et maintenant profites.",
        "Voilà l'église\nvoilà le parvis\ntu ouvres les portes\net tu trouves _.",
        "Comment j'ai perdu ma virginité ?",
        "Durant son enfance, Dali à fait des milliers de peintures de _.",
        "Dans 1000 ans, quand les billets n'auront plus aucune valeur, on paiera les services et les biens avec _.",
        "_, ce que tu n'aimerais pas trouver dans ton poulet",
        "Papa, c'est quoi _?"
    ]
    white_fr = [
        ...
        "Pondre un oeuf.",
        "Le pape.",
        "Des piercings sur les zones érogènes.",
        "Le doigtage.",
        ...
        "Les nippons.",
        "Les terroristes.",
        "Tricher aux Handisports.",
        "Un porno gay Allemand.",
        "La vague bleu Marine.",
        "Jamel.",
        "Un enfant handicapé.",
        "Le placenta.",
        "Schwarzy en costume BDSM.",
        "Des gobelins.",
        "Mourir.",
        "Une salade tomates/prépuces de bébé/feta.",
        " Une bataille de sex-pillows.",
        "La gaule matinale.",
        "Un chapeau original.",
        "Ribéry.",
        "réchauffer le cœur des orphelins.",
        "Le clitoris.",
        "Une masturbation malheureuse.",
        "Les hommes.",
        "Un micropenis.",
        "Une attaque de raptor.",
        "l’agriculture.",
        "Les Vikings.",
        "Faire semblant de s’intéresser.",
        "Mes courbes.",
        "Etre une bite avec les enfants.",
        "Des oies enragées.",
        "Sniffer de la colle.",
        "Des ladyboys séropositifs.",
        "Le complexe d’oedipe.",
        "Manger des cookies au raisins.",
        "Faire du sexting.",
        "FAIRE UN BARREL ROLL.",
        "La destruction mutuelle assurée.",
        "Un lever de soleil et des arcs-en ciel.",
        "Partager ses aiguilles.",
        "Etre riche.",
        ...
        "Michael Jackson.",
        "Des émotions.",
        "Péter dans un ascenseur.",
        "La nécrophilie.",
        "Une combustion humaine spontanée.",
        "Une infection vaginale.",
        "Laisser un message vocal douteux.",
        "Marc Dutroux.",
        "Les blancs.",
        "Une biflette.",
        "Apprendre à un robot l’amour.",
        "Du sperme de baleine.",
        "Faire le sexe avec un panda.",
        "En mettre partout.",
        "Des catapultes.",
        "La masturbation.",
        ...
        "Gandhi à poil.",
        "Les ados prépubères.",
        "La collection complète de Katsuni.",
        "Le syndrome de Stockholm.",
        "Des mines à détonation.",
        "Un zizi-oreille au petit matin.",
        "Un burrito bien épicé.",
        "Antoine Daniel.",
        "Une paire de couilles.",
        "Une capote orale.",
        "Une bouteille remplie de poils de cul.",
        "Un petit poney.",
        "Attendre le mariage pour lui dire.",
        "La cuisine mexicaine authentique.",
        "Les viols de Gengis Khan.",
        "L’odeur des vieux.",
        "Donner à manger à Depardieu.",
        "Un bukkake pixelisé.",
        "Des amis pour le bénéfice.",
        "Se faire gauler en matant un porno.",
        "Une bombe nucléaire.",
        "L’enlèvement.",
        "Un congélateur plein d’organes.",
        "Une douce vengeance.",
        "Ta mère.",
        "Le commandant Picard.",
        "Boire tout seul.",
        "Donner 110%.",
        "Des bactéries mangeuses de cyprine.",
        "Allez la France.",
        "Retirer son T-shirt.",
        ...
        "La fin de l’univers.",
        "La folie des Hommes.",
        "Un dildo court-circuité.",
        "Les cartes contre l’humanité.",
        "Des pets ardents.",
        "Les SDF.",
        "Des sous-vêtements comestibles.",
        "Britney Spears à 55 ans.",
        "Un buffet de crevettes.",
        "Manger sa merde.",
        "Une fête originale.",
        "La fraternité juive.",
        "Etre un putain de sorcier.",
        "Ejaculer.",
        "Un cintre, des aiguilles de couture et une bouteille en plastique.",
        "Un calendrier de furry.",
        "La sainte pelle.",
        "Une agression passive.",
        "DSK.",
        "Un homicide sur la route.",
        "Des tétons coupants.",
        "Les nains sodomites.",
        "Le no nut November.",
        "Morandini.",
        "Les problèmes de pères.",
        "Jean -pierre Coffe.",
        "Angela Merkel.",
        "Se réveiller nu dans un parking.",
        "Marine le Pen défoncant François Hollande avec un gode-ceinture.",
        "James Bond.",
        "Les solos de saxo.",
        "Un gloryhole.",
        "Vrchat.",
        ...
        "Le scalp.",
        "Dark vador.",
        "Couper l’arbre le plus vieux du monde.",
        "Les gars qui ne rappellent pas.",
        "Des doritos.",
        "Un paradoxe temporel.",
        "Le laitier.",
        "Des couilles tordues.",
        "Le jeu de la biscotte.",
        "La paix dans le monde.",
        "Une surprise salée.",
        "Des blagues sur l’Holocauste à Auschwitz.",
        "Donner de la MDMA à un sdf.",
        "Lécher pour s’approprier.",
        "Un cœur d’enfant.",
        "Robert Downey, Jr.",
        "Une cuillère tordue, un briquet et une seringue.",
        "Un rail de plâtre.",
        "Tir ami.",
        "Porter ses sous-vêtements à l’extérieur pour garder sa lessive.",
        "L’ouragan Katrina.",
        "Des échantillons gratuits.",
        "Faire ses brasses dans une piscine remplie de larmes d’enfants.",
        "Avoir la bouche pleine.",
        "Les communistes bobos.",
        "Des explosions.",
        "Les jambes d’Oscar Pistorius.",
        "Etre complètement défoncé.",
        "L’attitude.",
        "Une pipe au miel.",
        "Les juifs polonais.",
        ...
        "72 vierges.",
        "Les frites au bacon de Burger King.",
        "Se faire mordre le gland par une tortue de Floride.",
        "Le sang du christ.",
        "Ma collection high tech de jouets pour adultes.",
        "Un quarantenaire en trottinette.",
        "Les putes.",
        "L’omelette du fromage.",
        "Les Italiens.",
        "Un moulin rempli de corps.",
        "Un paki avec un bouquet de roses.",
        "La dette.",
        "La puberté tardive.",
        "Faire le beau.",
        "Pisser un calcul rénal.",
        ...
        "Un sextoy usagé.",
        "Un sac de bonbons.",
        "Un boobjob assymetrique.",
        "Des parents morts.",
        "Faire un trou dans sa poche pour se masturber en public.",
        "Un porno voyeur.",
        "Le point G.",
        "Stephen Hawking qui se fait masturber.",
        "La Somalie.",
        "La surcompensation.",
        "Etre en feu.",
        "Auschwitz.",
        "Mes parties.",
        "Ne pas reprocher le sexe oral.",
        "La lactation.",
        "Etre fabuleux.",
        "John Cena.",
        "Mon statut relationnel.",
        "Les asiatiques nuls en maths.",
        "L’alcoolisme.",
        "l’inceste.",
        "Voler une pierre tombale.",
        "L’espoir.",
        "La consanguinité.",
        "Les enfant victimes du cancer du cul.",
        "Mater des vieux.",
        "La danse de Fortnite.",
        "Justin Bieber.",
        "Le faire dans l’anus.",
        "Une vie triste.",
        "Un voleur obèse.",
        "Une réserve d’enfants.",
        "La cave à Patrique.",
        "Le New Age music.",
        "Se foutre du tiers monde.",
        "Un canapé taché.",
        "Les grands donateurs de la banque de sperme.",
        "Un joyeux bordel.",
        "Du chocolat pour attirer les enfants.",
        "Un hentai avec des tentacules.",
        "Une partouze gay.",
        "Les homos.",
        "Les sectes droguées.",
        "Le nez de Voldemort.",
        ...
        "Le racisme.",
        "Sodomie surprise!",
        "Une matraque mal placée.",
        "Des travestis passables.",
        "Crier Allauh Akbar dans un aéroport.",
        "Quand tu pettes et que ca sort.",
        "Un fœtus anorexique.",
        "L’obésité.",
        "Les gens chauds.",
        "BATMAN!!!",
        "Les noirs.",
        "Une antilope à moteur.",
        "Les tendances sexuelles.",
        "La troisième base.",
        "Tchernobyl.",
        "Les porn stars.",
        "Un pistolet à eau rempli de pisse.",
        "Mais ou est Charlie ?",
        "La puberté.",
        "Fêter ses 18 ans à la fistinière.",
        "Une érection de plus de quatre heures.",
        "Les privilèges des blancs.",
        "Avoir une érection d’énervement.",
        "Les devoirs de la femme.",
        "Deux nains qui chient dans un seau.",
        "Une chaudière remplie de foutre.",
        "Essuyer son cul.",
        "Les golden showers.",
        "Barack Obama.",
        "Les nazis.",
        "Un mongoloide robuste.",
        "Abandonner son enfant handicapé.",
        "Mussolini.",
        "Les pubs pour les yaourts.",
        "Des grosses cuisses.",
        "Mr. Propre, toujours derrière vous.",
        "Les végans.",
        ...
        "Les enfants avec une laisse.",
        "Harry Potter erotica.",
        "Des bébés surgelés.",
        "Des centaures violeurs.",
        "Mamie.",
        "La famine.",
        "Peindre avec ses doigts.",
        "Un singe qui baise une noix de coco.",
        "Les restos du cœur.",
        ...
        "Le fromage fondu.",
        "Un préservatif défectueux.",
        "La maternité adolescente.",
        "S’attendre un rot et vomir par terre.",
        "La soupe brûlante.",
        "Regarder BFMTV nu.",
        "Le MechaHitler.",
        "Des sexpents volants.",
        "Le véritable sens de noël.",
        "Egorger le mouton dans sa baignoire.",
        "Pac-Man version porno.",
        "Mon vagin.",
        "Un montage de volley homoérotique.",
        "Voler ses bonbons à un enfant.",
        "La meth cristallisée.",
        "Exactement ce à quoi tu t’attendais.",
        "L’évolution naturelle de l’Homme.",
        "Des Post-it remplis de remarques.",
        "Un yodel inapproprié.",
        "Lady Gaga.",
        "La justice vigilante.",
        "Le rayon de la mort.",
        "Des cellules souches.",
        "Nicolas Cage.",
        "Avoir une demi-molle.",
        "Un seau rempli de têtes de poissons.",
        "50,000 volts dans les tétons.",
        "Une pyramide de têtes coupées.",
        "La crucifixion.",
        "Des sous-vêtements usagés.",
        "Une sucette beaucoup trop grosse.",
        "La shoah.",
        "Ne pas porter d’habits.",
        "Le sexe consensuel.",
        "Sa majesté, la Reine Elizabeth II.",
        "L’art de la séduction.",
        "Le diable en personne.",
        "Conseil d’un vieil homme noir.",
        "Détruire les preuves.",
        "La lumière d’un million de soleils.",
        "Des rêves secs.",
        "Silence.",
        "Un fusil M16.",
        ...
        "Un coup de pute.",
        "Un trillion d’euro.",
        "Des bouts de prostituée morte.",
        "L’orgasme féminin.",
        "Les stormtroopers.",
        "Lancer une vierge dans un volcan."
    ]

    global black_hu, white_hu
    black_hu = [
        "Mért nem tudok aludni este?",
        "Van 99 problémám, de _ nem az.",
        "Mi egy lány legjobb barátja?",
        "Mi ez a szag?",
        "Így végződik a világunk / Így végződik a világunk / Nem egy durranással hanem _.",
        "Mi Batman bűnös élvezete?",
        "TSA előírások mostantól megtiltják a(z) _ -t a repülőgépeken.",
        "Mi miatt ért véget a legutóbbi párkapcsolatom?",
        "MTV új valóságshowja tartalmaz nyolc mosott hírességet, akik együtt élnek _-val/vel.",
        "Iszok hogy elfelejtsem a(z) _ -t.",
        "Sajnálom Professzor, nem tudtam befejezni a házifeladatom mert _.",
        "Alternatív orvoslás most már rendelkezik a _ gyógyító erejével.",
        "Mi ez a hang?",
        "Mi a következő Happy Meal játék?",
        "Eléggé szánalmas, hogy a mai gyerekek egyre többet törődnek a _-val/vel.",
        "A Disney Channel új és eredeti filmjében Hannah Montana először küszködik _-val/vel.",
        "_. Úgy akarok meghalni.",
        "Mit részesít előnyben Dick Cheney?",
        "Mi a legemóbb?"
        "Szén helyett Télapó mostmár _-t ad a rossz gyerekeknek."
        "A következő J.K. Rowling-tól: Harry Potter és a _ kamrája.",
        "Egy romantikus, gyertyalángos vacsorában kihagyhatatlan a _.",
        "White people like _.", "Fehér emberek kedvence a _."
                                "_. Fogadjunk hogy nem lehet csak egy neked!",
        "Háború!\n\nMire jó?",
        "ITT VAN BILLY MAYS HOGY _."
        "_. Pacsi, tesó.",
        "Szex közben szeretek _-ra/re gondolni.",
        "Mit hoztam vissza Mexikóból?",
        "Mit rejtegetnek előlem a szüleim?",
        "Mitől biztos hogy biztosan ágyba viszel valakit?"
        "Mitől lenne a nagyi elundorodva, de furcsán elbűvülve is?",
        "Mit dobott le az USA az Afganisztáni gyerekeknek repülőgépeikből?",
        "Mi segít Obamának lazítani?",
        "Miből van egy csomó a mennyben?",
        "Major League Baseball betiltotta a _-t, mert előnyt adott a játékosoknak a többiekkel szemben.",
        "Ha milliárdos leszek, emelek egy 15m magas szobrot _ emlékére.",
        "Mi az új őrületes diéta?",
        "Ha én leszek az Egyesült Államok elnöke, létre fogom hozni a _ Osztályát.",
        "_. Ez egy csapda!",
        "Hogy tartom fenn a párkapcsolati státuszomat?",
        "Mit fogok visszavinni az időben, hogy meggyőzzem az embereket arról hogy egy erős varázsló vagyok?",
        "Míg az Egyesült Államok versenyzett a Szovjet Unió ellen a Holdig, addig a Mexikói kormány több millió peso-t beleölt a _ kutatásába.",
        "Jön a Broadway-re ebben a szezonban, _: A Musical.",
        "Mi a titkos szupererőm?",
        "Mitől szellentek megállíthatatlanul?",
        "De mielőtt megöllek téged, Mr. Bond, meg kell mutatnom _-t.",
        "Mi az ami sosem bukik el a parti felélesztésében?",
        "Mit adok fel Lentért?",
        "Milyen illata van az idős embereknek?",
        "Az osztálykirándulás teljesen tönkre lett téve (a) _ által.",
        "Miután a Fáraó nem tett semmit, Mózes egy _ csapást hívott le.",
        "Nem tudom milyen fegyverekkel lesz a harmadik világháború megharcolva, de azt tudom hogy a negyedik világháborúban _-val/vel fogunk harcolni.",
        "Mit használ a Teach for America hogy inspirálja a belvárosi gyerekeket a sikerre?",
        "Michael Jackson az utolsó pillanataiban _-ra/re gondolt.",
        "Miért fáj mindenem?",
        "Tanulmányok kimutatják, hogy a laboratóriumi patkányok 50 % -al gyorsabban oldanak meg labirintusokat, miután _ hatásának lettek kitéve.",
        "Mért ragadok?",
        "Mi az anti-drogom?",
        "És az Akadémiai Díjt kapja _.",
        "A következő trükkömben megpróbálok kiszedni egy _-t egy _-ból/ből.",
        "_: Jó az utolsó cseppig.",
        "Mit evett Vin Diesel reggelire?",
        "_: gyerek-tesztelt, anya-jóváhagyta.",
        "Mi lesz jobb idővel?",
        "Sokáig nem értettem _-t, de aztán találkoztam _-val/vel."
        "Egyes pletykák szerint Vladimir Putyin kedvenc finomsága a _-val/vel töltött _.",
        "Lifetime bemutatja: _, egy _ története.",
        "Csinálj egy haiku-t.",
        "M. Night Shyamalan új filmjében Bruce Willis felfedezi azt hogy _ egész végig _ volt.",
        "_ egy csúszós lejtő, amely _-hoz/hez vezet.",
        "Egy világban amit _ elpusztított, az egyetlen enyhülésünk a _.",
        "Igen, megöltem _-t. Mért kérded? _.",
        "Amikor kábítószereztem, _ átváltozott _-vá/vé.",
        "_ + _ = _.",
        "Mi a következő szuperhős/annak társa páros?",
        "Kedves Abby,\n\nVan egy kis problémám a _-val/vel, és szeretnék tőled tanácsot kérni.",
        "A földrengés után Sean Penn _-t hozott Haiti lakosainak.",
        "Állítólag L.A. megyei börtönében 200 cigiért kaphatsz _-t.",
        "Talán vele született. Talán _.",
        "Az amerikai indiánok élete örökre megváltozott, miután a Fehér Ember bemutatta nekik a _-t.",
        "Következőnek az ESPN2-n, a _ világ sorozata.",
        "1. Lépés:_. 2.Lépés:_. 3.Lépés:Profit.",
        "Itt van a templom\nItt van tornya\nNyisd a kaput és nézz csak oda:_.",
        "Hogy vesztettem el a szüzességem?",
        "Gyerekkorában Salvador Dali több száz _ festményt alkotott.",
        "1000 év múlva, amikor a papírpénz már csak távoli emlék, hogy fogunk fizetni?",
        "Mit nem szeretnél találni a Kung Pao csirkédben?",
        "A Smithsonian Természettudományi Múzeum éppen létrehozott egy _ kiállítást.",
        "Apu, miért sír anyu?"
    ]
    white_hu = [
        "Akasztó abortuszok.",
        "Férfi 'hús'.",
        "Automatikus kannibalizmus.",
        "Élénk jazz hands.",
        "Röpképtelen madarak.",
        "Képek mellekről.",
        "A jó dolgot csinálni.",
        "A legalapabb emberi jogok megsértése.",
        "Viagra.",
        "Önutálat.",
        "Elképesztő hasizom.",
        "Kiegyensúlyozott reggeli.",
        "Roofies (kábítószer).",
        "Eltitkolni egy erekciót.",
        "Amputált emberek.",
        "Az Ősrobbanás.",
        "Egykori elnök, George W. Bush.",
        "A Fordított Dr. Martin Luther King, Jr.",
        "Szmegma.",
        ...
        "A Pápa.",
        "Aaron Burr.",
        "Nemiszervi piercing-ek.",
        "Ujjazni.",
        "Egy hipózott segglyuk.",
        "Lóhús.",
        "Maga a félelem.",
        "Tudományos.",
        "Idősebb japán férfi.",
        "Idegenveszély.",
        "A terroristák.",
        "Elimádkozni a melegeket.",
        "Azonos nemű jégtáncolás.",
        "Etnikai tisztogatás.",
        "Csalni a Special Olympics-ben.",
        "Német várbörtön pornó.",
        "Bulimia.",
        "Mogorva arcot vágni.",
        "William Shatner.",
        "Heteronormativitás.",
        ...
        "Láncfűrész kezek.",
        "Arnold Schwarzenegger.",
        "Egy jégcsap lobotómia.",
        "Goblinok.",
        "Tárgyi állandóság.",
        "Meghalás.",
        "Fityma.",
        "Egy sólyom kalappal a fején.",
        "Hormon injekciók.",
        "Vérhas általi halál.",
        "Szexi párnacsaták.",
        "A láthatatlan kéz.",
        "Egy nagyon menő sapka.",
        "Sean Penn.",
        "Szívmelengető árvák.",
        "A csikló.",
        "A három ötödik kompromisszum.",
        "Férfi.",
        "Történelmileg fekete főiskolák.",
        "Egy mikropénisz.",
        "Raptor támadások.",
        "Agrikultúra.",
        "Vikingek.",
        "Úgy tenni mint ha érdekelne.",
        "A Földalatti Vasút.",
        "A púpjaim.",
        "Seggfejnek lenni gyerekekhez.",
        "Libák.",
        "Bling.",
        "Ragasztószaglás.",
        "A Dél.",
        "Egy Ödipusz-komplexus.",
        "Megenni az összes sütit az AIDS süteményvásáron.",
        "Sexting.",
        "TÖBB TÁVVEZETÉKOSZLOPOT KELL ÉPÍTENED.",
        "Kölcsönösen biztosított megsemmítés.",
        "Napfény és szivárványok.",
        "Count Chocula (müzli).",
        "Tűk megosztása.",
        "Gazdagnak lenni.",
        "Skeletor.",
        "Egy kolbász fesztivál.",
        "Michael Jackson.",
        "Érzések.",
        "Fingani, majd elsétálni.",
        "A kínai gimnasztikai csapat.",
        "Nekrofília.",
        "Spontán emberi égés.",
        "Élesztő.",
        "Hagyni egy kínos voicemail-t.",
        "Dick Cheney.",
        "Fehér emberek.",
        "Pénisz irigység.",
        "Megtanítani egy robotot hogy szeressen.",
        "Ámbráscetek.",
        "Súrolni a redők alatt.",
        "Panda szex.",
        "Kiverni/Kihúzni.",
        "Katapultok.",
        "Maszturbáció.",
        "Természetes kiválasztódás.",
        "Szembeállítható hüvelykujjak.",
        "Egy pimasz fekete nő.",
        "AIDS.",
        "A KKK.",
        "Füge pudding.",
        "Seppuku.",
        "Gandhi.",
        "Fiatal tinédzser.",
        "Toni Morrison vaginája.",
        "5 dolláros hotdog.",
        "Aknák.",
        "Bajok tengere.",
        "Egy ízletes reggeli burrito.",
        "Christopher Walken.",
        "Súrlódás.",
        "Golyók.",
        "Fogászati gátak.",
        ...
        "Egy pici ló.",
        "Házasságig várni.",
        "Hiteles mexikói konyha.",
        "Dzsingisz kán.",
        "Öregember szag.",
        "Megetetni Rosie O'Donnell-t.",
        "Pixelesített nagy mellek.",
        "Barátság extrákkal.",
        "A token kisebbség.",
        "A Tempur-Pedic svéd alvásrendszere.",
        "Egy termonukleáris robbanás.",
        "Take-backsie-k.",
        "Az elragadtatás.",
        "Egy fagyasztó, teli szervekkel.",
        "Szép édes bosszú.",
        "RoboCop.",
        "Keanu Reeves.",
        "Egyedül inni.",
        ...
        "Levenni a pólódat.",
        "Szabadidőm.",
        "Egy gyilkosság bolondság.",
        "Az elkerülhetetlen hőhalála az univerzumnak.",
        "Az ember bolondja.",
        "Az a dolog ami megrázza a hasizmodat.",
        "Cards Against Humanity.",
        "Tüzes szarás.",
        "Szegény emberek.",
        "Ehető alsónadrág.",
        "Britney Spears 55 évesen.",
        "Minden-amit-megeszel garnélarák $4.99.-ért",
        "Szarni oda-vissza. Örökre."
        "Díszes ünnep.",
        "Zsidó testvériség.",
        "Egy kibaszott varázslónak lenni.",
        "Kihúzni.",
        "Csajokat felszedni az abortusz klinikán.",
        "A meleg agenda.",
        "A Szent Biblia.",
        "Passzív-agresszió.",
        "Ronald Reagan.",
        ...
        "Mellbimbó pengék.",
        "Seggnélküli fickók.",
        "Teljes előnézeti meztelenség.",
        "Hulk Hogan.",
        "Apuci problémák.",
        "A keményen dolgozó mexikói.",
        "Natalie Portman.",
        "Felkelni félig meztelenül egy Denny's parkolóban.",
        "Isten.",
        "Sean Connery.",
        "Szaxofon szólók.",
        "Gloryhole-ok.",
        ...
        "Fejvédő.",
        "Darth Vader.",
        "Megenni a legutolsó ismert bivalyt.",
        "Srácok akik nem hívnak.",
        "Hot Pockets.",
        "Egy időutazási paradoxon.",
        "Egy tejesember.",
        "Nemiszervi torzió.",
        "Ledobni egy csillárt az ellenségeidre, majd felhúzni a kötelet.",
        "Világbéke.",
        "Egy sós meglepetés.",
        "Rosszul időzített Holokauszt viccek.",
        "Himlő takarók.",
        "Megnyalni dolgokat hogy megjelöld őket mint a sajátod.",
        "Egy gyerek szíve.",
        "Robert Downey, Jr.",
        "Merevgörcs.",
        "Eugenika.",
        "Egy jó szaglás.",
        "Baráti tűz.",
        "A fertőzöttség; a gát; a húsos móka-híd.",
        "Kifordítva viselni az alsóneműt, hogy ne kelljen mosni.",
        "Katrina-hurrikán.",
        "Ingyenes kóstolók.",
        "Kiverni egy medencényi gyermekkönnybe.",
        "Egy rossz száj.",
        "Az üvegtető.",
        "Republikánok.",
        "Robbanások.",
        "Michelle Obama karjai",
        "Nagyon beszívottnak lenni.",
        "Hozzáállás.",
        "Sarah Palin.",
        "Az Übermensch.",
        "Oltár fiúk.",
        ...
        "Pedofilok.",
        "72 szűz.",
        "Pabst Blue Ribbon (sör).",
        "Domino's Oreo Desszert Pizza.",
        "Egy csípegő teknős megharapja a péniszed hegyét.",
        "Jézus vére.",
        "Alkalmatlan előjáték.",
        "A High-Tech szex játék kollekcióm.",
        "Egy középkorú férfi görkorin.",
        "Kurvák.",
        "Bill Nye the Science Guy.",
        "Olaszok.",
        "Egy szélmalom, teli hullákkal.",
        "Adderall.",
        "Bomlasztó adóság.",
        "Egy kóbor fanszőr.",
        "Táncolni.",
        "Átadni egy vesekövet.",
        "Agyi tumor.",
        "Lepra.",
        "Kutyusok!",
        "Méhek?",
        ...
        "Útfej.",
        "Egy zsák varázsbab.",
        "Egy aszimmetrikus boob job.",
        "Halott szülők.",
        "Nyilvános gúnyűzés.",
        "Párosító kijelző.",
        "Egy pantomim sztrokot kapott.",
        "Stephen Hawking piszkosan beszél.",
        "Afrikai gyerekek.",
        "Szájherpesz.",
        "Túlkompenzálás.",
        ...
        "Auschwitz.",
        "A heréim.",
        "Orál szex nem viszonyzása.",
        "Szoptatás.",
        "Gyönyörűnek lenni.",
        "Shaquille O'Neal színészi karriere.",
        "A párkapcsolati státuszom.",
        "Ázsiaiak, akik nem jók matekból.",
        "Alkoholizmus.",
        "Vérfertőzés.",
        "Sírtolvajlás.",
        "Remény.",
        "200 g édes mexikói fekete kátrány heroin.",
        "Gyerekek seggrákkal.",
        "Öregekre kacsintani.",
        "A zsidók.",
        "Justin Bieber.",
        "A fenékben csinálni.",
        "Egy szomorúsággal teli élet.",
        "A hamburgertolvaj (hamburglar).",
        "Seperni.",
        "Klasszicista felhang.",
        "Új korszak zenéje.",
        "Leszarni a harmadik-világ országait."
        "A Kool-Aid Man.",
        "Egy szexi összeszedetlenség.",
        "Csáp pornó.",
        "Favágó fantáziák.",
        "A melegek.",
        "Szcientológia.",
        ...
        "Meglepetés szex!",
        "Rendőri brutalitás.",
        "Passzolható transzvesztiták.",
        "A Virginia Tech Mészárlás.",
        "Amikor fingasz, és egy pici kijön.",
        "Oompa-Loompas.",
        "Egy magzat.",
        "Elhízottság.",
        "Fincsi mellékmell.",
        ...
        "BATMAN!!!",
        "Fekete emberek.",
        "Egy szénsavas antilop.",
        "Szexuális feszültség.",
        "Harmadik bázis.",
        "Rasszon alapuló SAT kérdések.",
        "Pornósztárok.",
        "A Super Soaker full of cat pee.",
        "Mohammed (Áldás rája).",
        "Pubertáskor.",
        "Egy elszomorító születésnapi parti.",
        "Egy erekció ami tovább tart mint 4 óra.",
        "Fehér kiváltság.",
        "Olyan mérgesnek lenni, hogy erekciód lesz.",
        "Asszonyi kötelességek.",
        "Két törpe egy vödörbe szarnak.",
        "Hüvely pukizni.",
        "Kitörölni a seggét.",
        "Aranyesők.",
        "Barack Obama.",
        "Nácik.",
        "Egy erős mongoloid.",
        "Egy M. Night Shyamalan plot twist.",
        "Leinni magad szájvízzel.",
        "Lunchables (uzsonnacsomag).",
        "Nők a joghurt reklámokban.",
        "John Wilkes Booth.",
        "Erőteljes combok.",
        "Mr. Clean, éppen mögötted.",
        "Több késelési nyom.",
        "Kibernetikus fejlesztések.",
        "Jobbágyság.",
        "Kanye West.",
        "Nők szavazói joga.",
        "Gyerekek pórázon.",
        "Harry Potter erotika.",
        "The Dance of the Sugar Plum Fairy (dal).",
        "Lance Armstrong hiányzó heréje.",
        "A Vörös-tengernél való elválás.",
        "Az Amish (nép).",
        "Halott babák.",
        "Gyermek szépségápolási pályázók.",
        "AXE dezodor.",
        "Kentaurok.",
        "Megélni egy érzést.",
        "Nagyi.",
        "Éhezés.",
        "Könnyek útja.",
        "A gyermekszületés csodája.",
        "Ujjfestés.",
        "Egy majom pipázik.",
        "A Make-A-Wish Intézmény.",
        "Anális rózsafüzér.",
        "Az Erő.",
        "Kamikaze pilóták.",
        "Száraz hullámzás.",
        ...
        "The Hustle (film).",
        "Pisilni egy picit.",
        "Még egy átkozott vámpíros film.",
        "Alakváltók.",
        "A Care Bear bámulás.",
        "Meleg sajt.",
        "Egy mogorva állatkerti oroszlán.",
        "Egy rossz óvszer.",
        "Tinédzser terhesség.",
        "Egy Bop It.",
        "Egy büfire számítani, de a padlóra hánysz.",
        "Szörnyű lézerrel való hajeltávolítási balesetek.",
        "Taknyok.",
        "Meg nem valósítható baromság.",
        "Elkezdeni énekelni és táncolni.",
        "Nagyon forró leves.",
        "Morgan Freeman hangja.",
        "Meztelenkedve Nickelodeon-t nézni.",
        "Mechanikus Hitler.",
        "Repülő szexkígyók.",
        ...
        "Pac-Man uncontrollably guzzling cum.",
        "A vaginám.",
        "Egy homoerotikus röplabda montázs.",
        "Tényleg elvenni a cukrot a babától.",
        "Crystal meth.",
        "Pont az amire számítottál.",
        "Természetes férfi fejlesztés.",
        "Passzív-agresszív Post-it lapok.",
        "Alkalmatlan yodelling.",
        "Lady Gaga.",
        "The Little Engine That Could (könyv).",
        "Éber igazságosztás.",
        "Halálos sugár.",
        "Rossz életmód.",
        "Egy udvariasan körbeölelő belső comb.",
        "Embrionális őssejtek.",
        "Nicolas Cage.",
        "Puskával lövöldözni a levegőbe, miközben az illető egy disznóba 'hatol be'.",
        "Átváltani Geico-ra.",
        "A krónikus.",
        "Merevedési zavar.",
        "Otthoni videó, melyben Oprah belezokog Lean Cuisine-be.",
        "Egy vödörnyi halfej.",
        "50,000 V egyenesen a mellbimbóba.",
        "Kövérnek és hülyének lenni.",
        "Menedékházi gondozás.",
        "Egy levágott fej piramis.",
        "Megházasodni, néhány gyerekkel élni, venni pár cuccot, nyugdíjba vonulni Floridában, és meghalni.",
        "Egy előfizetés a Men's Fitness-re."
        "Keresztrefeszítés.",
        "Egy apró malac egy apró esőkabátot és csizmát visel.",
        "Valamennyi átkozott csönd és béke.",
        "Használt bugyik.",
        "Harcoló nők törzse.",
        "Penny síp szóló a \"My Heart Will Go On.\"-ból",
        "Egy túlméretezett nyalóka.",
        "Megállás nélkül nevetni Hutus vagy Tutsis hallatán.",
        "Nem viselni nadrágot.",
        "Konszenzuális szex.",
        "Ő felsége, II. Elizabeth királynő.",
        "Dzsesszes friss rímek.",
        "A csábítás művészete.",
        "Maga az ördög.",
        "Tanács egy vén, bölcs, fekete embertől.",
        "A bizonyíték elpusztítása.",
        "Egy milliárd nap fénye.",
        "Nedves álmok.",
        "Szinergikus menedzsment megoldások.",
        "Növekvő pár.",
        "Csönd.",
        "Egy M16 assault rifle.",
        "Koszos pelenka.",
        "Élő stúdiós közönség.",
        "A Nagy Depresszió.",
        "Egy görcsös kockafejű.",
        "Rush Limbaugh puha, hasztalan teste.",
        "Sean Hannity csikizése, még azután is miután elmondta hogy hagyd abba.",
        "Sztálin.",
        "Barna emberek.",
        "Rehabilitáció.",
        "Elfogni Newt Gingrich-et és ráerőltetni hogy táncoljon egy majomjelmezben.",
        "Csatatéri amputációk.",
        "Egy felütés.",
        "Csillogó tárgyak.",
        "Egy ronda arc.",
        "Menstruációs harag.",
        "Egy bitch slap.",
        "Egy trilliárd dollár.",
        "Halott prosti darabjai.",
        "Az egész Mormon Tabernakulus Kórus.",
        "A női orgazmus.",
        "Nagyon szoros nadrág.",
        "Amerikai Boy Scouts.",
        "Stormtrooper-ek.",
        "Vulkánba dobni egy szűzt.",
    ]
